        ...
        <div className="col-lg-9">
          <div className="app__hero__name">
            ...
            <p className="app__hero__desc pt-3">
              I am a Frontend Developer and UI Designer. Currently, I spend most
              of my time honing my development & design skills. Learning new
              skills and improving on what I already know is a strong passion of
              mine.
            </p>
